  ...
  return (
    <main className="bg-[#f4f6f4]">
      ...
      <section className="min-h-[440px] py-20 px-[clamp(22px,6vw,92px)] max-[760px]:px-5 grid grid-cols-[1.2fr_0.8fr] max-[800px]:grid-cols-1 gap-14 items-center bg-[#0d2b32] text-white gs-reveal">
        ...
        <div><p className="text-white/65 text-sm leading-[1.75]">Share the chemical name, specification, application, packing and destination.</p><a className="button button-light mt-4 inline-flex items-center gap-2.5" href={WA_HREF} target="_blank" rel="noopener noreferrer"><WhatsApp /> Enquire on WhatsApp</a></div>
      </section>
